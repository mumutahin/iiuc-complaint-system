...
export default function ProfilePage() {
  const { profile, currentUser, refreshProfile, deleteAccount } = useAuth();
    ...
    <div className="mx-auto max-w-lg px-4 py-8 sm:px-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-rose-700/80 dark:text-rose-300/70">
              Deleting your account removes your login permanently. Complaints you've already submitted stay on
              record for the university — they won't be deleted, but they'll show as submitted by a deleted user.
            </p>
            <button
              type="button"
      ...
      <Modal open={deleteOpen} onClose={() => setDeleteOpen(false)} title="Delete your account?" size="sm">
        <p className="text-sm text-ink/60 dark:text-white/50">
          This is permanent — you'll be signed out and won't be able to log back in with this account. Your
          complaints will remain visible to staff for record-keeping.
        </p>
